...
const mcp = new Server(
  { name: 'discord', version: '1.0.0' },
  {
    ...
    instructions: [
      ...
      '',
      'The Discord sender and your terminal user are usually the same person reading two screens, and they watch this channel even when they type in the terminal. Mirror EVERYTHING user-facing to the channel for every turn, including terminal-typed prompts: interim progress notes while you work (prefer one message updated via edit_message, since edits do not ping) and the final result as a fresh reply (that one pings). No substance may exist only in the transcript. End the turn with the literal transcript text "Replied on Discord." and never refer to the user in the third person.',
      '',
